...
export interface CompendiumMatch {
   ...
   *  compendium document cache. Lets the shop UI render per-tile
   *  prices without issuing a follow-up get-compendium-document call
   *  per result. Absent for uncached packs. */
  price?: ItemPrice;
}
